...
statistics_for_max_elf = statistics[max_elf[0]]
# print(statistics_for_max_elf)

count_per_minute = defaultdict(lambda: 0)
for stat in statistics_for_max_elf:
    start = stat[0]
    stop = stat[1]
...
max_elf_id = int(max_elf[0])
print(max_elf_id)
print(max_min)
print(max_min * max_elf_id)
